...
source("R/sc/sc_communication_velocity.R")  # V1.x-C (CCC avancée Phase 2) : contexte vélocité, APRES sc_communication_trajectory.R  # V1.x-B (CCC avancée Phase 3) : contexte trajectoire/pseudo-temps, APRES sc_communication_spatial.R  # V1.x-A (CCC avancée Phase 1) : contexte spatial, APRES sc_communication_views.R
...
source("modules/sc/mod_sc_communication_velocity.R")  # V1.x-C : onglet « Contexte vélocité » du panneau Communication  # V1.x-B : onglet « Contexte trajectoire » du panneau Communication  # V1.x-A : onglet « Contexte spatial » du panneau Communication
